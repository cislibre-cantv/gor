...
/**
 * This is the model class for table "cnx_active_record_log".
 *
 * The followings are the available columns in table 'cnx_active_record_log':
 * @property string $id
